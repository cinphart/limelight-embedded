...
/**
 * Class that handles absolute input ranges from evdev device - making the value always 0 based.
 * @author Iwan Timmer
 */
public class EvdevAbsTrigger {
	...
	public EvdevAbsTrigger(String filename, int axis, boolean reverse) {
